...
def build_family_rows() -> list[dict[str, int]]:
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Search raw ALMS family table serializations that verify modulo 19 and/or 7."
    )
    ...
    field_names = ["surah", "elif", "lam", "mim", "sad", "total", "length"]
